...
public class LectorService {
    ...
    public String getReferencedWarning(final Long id) {
        ...
        final Bibliotecario esLectorBibliotecario = bibliotecarioRepository.findFirstByEsLector(lector);
        if (esLectorBibliotecario != null) {
            return WebUtils.getMessage("lector.bibliotecario.esLector.referenced", esLectorBibliotecario.getId());
        }
        return null;
    }
